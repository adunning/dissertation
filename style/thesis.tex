...
% \frenchspacing % Prevents a stretchable space from being inserted after a period, which is nice, but can cause issues.
...
% Remove bold from headings in report class
\usepackage{sectsty}
\allsectionsfont{\normalfont}
